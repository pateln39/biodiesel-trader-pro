...
import { generateTradeReference } from '@/modules/trade/utils';
          ...
          <CardContent>
            ...
            >
              <TabsList className="grid w-full grid-cols-2 mb-6">
                <TabsTrigger value={TradeType.Physical}>Physical Trade</TabsTrigger>
                <TabsTrigger value={TradeType.Paper}>Paper Trade</TabsTrigger>
              </TabsList>
              
              <TabsContent value={TradeType.Physical}>
                <PhysicalTradeForm 
              ...
              <TabsContent value={TradeType.Paper}>
                <PaperTradeForm 
                  tradeReference={tradeReference} 
