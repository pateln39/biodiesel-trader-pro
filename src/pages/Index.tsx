...
// Mock data for the charts based on the image
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-brand-blue/30">
                      ...
                      <th className="text-right p-2">UCOME</th>
                      <th className="text-right p-2">FAME</th>
                      <th className="text-right p-2">RME</th>
                      <th className="text-right p-2">RME</th>
                    </tr>
                  </thead>
                  <tbody>
                    {physicalPositionData.map((row) => (
                      <tr key={row.month} className="border-b border-brand-blue/30">
                        <td className="text-left p-2">{row.month}</td>
                        <td className="text-right p-2">{row.UCOME}</td>
                        <td className="text-right p-2">{row.FAME}</td>
                        <td className="text-right p-2">{row.RME1}</td>
                        <td className="text-right p-2">{row.RME2}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
