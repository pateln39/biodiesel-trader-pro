                            ...
                            categoryProducts.forEach((product, index) => {
                              headers.push(
                                <TableHead 
                                  ...
                                  className={`text-right p-1 text-xs whitespace-nowrap border-t-0 border-r-[2px] border-black ${
                                ...
                                if (index === ucomeIndex && shouldShowBiodieselTotal) {
                                  ...
                                  cells.push(
                                    <TableCell 
                                      ...
                                      className={`text-right text-xs p-1 font-medium border-r-[2px] border-black ${getValueColorClass(biodieselTotal)} bg-green-50`}
                                    >
                              ...
                              if (shouldShowPricingInstrumentTotal) {
                                ...
                                cells.push(
                                  <TableCell 
                                    ...
                                    className={`text-right text-xs p-1 font-medium border-r-[2px] border-black ${getValueColorClass(pricingInstrumentTotal)} bg-blue-50`}
                                  >
                            ...
                            categoryProducts.forEach((product, index) => {
                              cells.push(
                                <TableCell 
                                  ...
                                  className={`text-right text-xs p-1 border-r-[2px] border-black ${
