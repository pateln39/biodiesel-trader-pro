...
// Define updated sticky positions for the frozen columns
        ...
        <Card className="border-r-[3px] border-brand-lime/60 bg-gradient-to-br from-brand-navy/75 to-brand-navy/90">
          ...
          <CardContent>
            ...
            <div className="overflow-x-auto relative">
              {/* Table with table-layout fixed for predictable column behavior */}
                ...
                <Table className="table-fixed">
                  ...
                  <TableHeader>
                    ...
                    <TableRow className="bg-muted/50 border-b border-white/10">
                      ...
                      <TableHead 
                        colSpan={9} 
                        className="border-r border-white/30 sticky left-0 z-20 bg-muted/50"
                        style={{ width: '950px' }}
                      >
                        {/* Empty space for fixed columns */}
                      </TableHead>
                    ...
                    <TableRow className="bg-muted/40 border-b border-white/10">
                      ...
                      <TableHead 
                        colSpan={9} 
                        className="border-r border-white/30 sticky left-0 z-20 bg-muted/40"
                      ></TableHead>
                    ...
                    <TableRow className="bg-muted/50 border-b border-white/10">
                      ...
                      <TableHead className={cn("w-[120px] sticky", stickyLeftOffsets[7], "z-20", "bg-muted/50")}>Comments</TableHead>
                  ...
                  <TableBody>
                    {mockInventoryMovements.map((movement) => {
                      ...
                      return (
                        ...
                        >
                          {/* First 9 columns - Static with sticky positioning and opaque backgrounds */}
