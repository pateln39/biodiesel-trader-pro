...
import { 
  ...
  PaperPricingFormula, 
  PaperExposureResult, 
  PartialPaperPricingFormula 
} from '@/types/paperFormula';
...
export const createInstrumentToken = (instrument: Instrument): PaperFormulaToken => {
  return {
    id: generateNodeId(),
    type: 'instrument',
    value: instrument,
...
export const createFixedValueToken = (value: number): PaperFormulaToken => {
  return {
    id: generateNodeId(),
    type: 'fixedValue',
...
export const createPercentageToken = (value: number): PaperFormulaToken => {
  return {
    id: generateNodeId(),
    type: 'percentage',
    value: value.toString(),
...
export const createOperatorToken = (operator: string): PaperFormulaToken => {
  return {
    id: generateNodeId(),
    type: 'operator',
    value: operator,
...
export const createOpenBracketToken = (): PaperFormulaToken => {
  return {
    id: generateNodeId(),
    type: 'openBracket',
    value: '(',
...
export const createCloseBracketToken = (): PaperFormulaToken => {
  return {
    id: generateNodeId(),
    type: 'closeBracket',
    value: ')',
...
export const createEmptyFormula = (): PaperPricingFormula => {
  return {
    tokens: [],
...
export const validateAndParsePricingFormula = (rawFormula: any): PaperPricingFormula => {
  ...
  const partialFormula: PartialPaperPricingFormula = {
...
export const ensureCompleteExposures = (formula: PartialPaperPricingFormula | undefined): PaperPricingFormula => {
  if (!formula) {
    return createEmptyFormula();
  }
...
export const formulaToString = (tokens: PaperFormulaToken[]): string => {
...
export const formulaToDisplayString = (tokens: PaperFormulaToken[]): string => {
