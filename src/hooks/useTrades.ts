    ...
    const mappedTrades = parentTrades.map((parent: DbParentTrade) => {
      ...
      if (parent.trade_type === 'physical' && firstLeg) {
        ...
        const physicalTrade: PhysicalTrade = {
          ...
          formula: firstLeg.pricing_formula as PricingFormula || createEmptyFormula(),
          mtmFormula: firstLeg.mtm_formula as PricingFormula || createEmptyFormula(),
          legs: legs.map(leg => ({
            id: leg.id,
            ...
            formula: leg.pricing_formula as PricingFormula || createEmptyFormula(),
            mtmFormula: leg.mtm_formula as PricingFormula || createEmptyFormula()
          }))
        };
